  ...
  return (
    <>
      ...
      <Header
        ...
        style={{ position: "fixed", padding: "5px" }}
      />
      ...
      <div>
        <div className="w-full flex flex-col">
              ...
              <div className="flex items-center justify-evenly md:flex-col">
                <div className="flex flex-col items-center w-full space-y-4 mt-4 text-center">
                  <Heading
                    size="s"
                    as="h1"
                    className="chroma-text text-blueLimeade leading-[56px] text-responsive"
                    data-text={content[languageindex].portfolioTitle}
                  >
                  ...
                  <Text
                    size="7xl"
                    as="h1"
                    className="chroma-text font-poppins-bold tracking-[1.50px] text-white text-responsive"
                    data-text={content[languageindex].headerTitle}
                  >
                  ...
                  <Text
                    size="4lg"
                    as="h3"
                    className="chroma-text font-lora-regular text-white uppercase"
                    data-text={`|${content[languageindex].titulo1}|${content[languageindex].titulo2}${content[languageindex].titulo3}|`}
                  >
                    |{content[languageindex].titulo1}|
                    {content[languageindex].titulo2}
                    {content[languageindex].titulo3}|
                  </Text>
                  <Contact
                    content={content}
                    languageindex={languageindex}
                    ...
                    withMessage
                    openInNewTab
                    buttonClassName="meu-estilo-personalizado"
                    transparent
                  />
                </div>
              </div>
            ...
            <div className="container-xs px-4 md:px-5">
              ...
              <div className="flex flex-col items-center w-full space-y-4 mt-4 text-center">
                <Heading
                  size="s"
                  as="h1"
                  className="text-blueLimeade leading-[56px] text-responsive"
                >
                ...
                <div className="flex flex-row md:flex-col items-center space-x-4 mt-4 text-center">
                  ...
                  <div className="flex flex-col items-center space-y-4 mt-4 text-center">
                    <Text
                      size="7xl"
                      as="h1"
                      className="font-poppins-bold tracking-[1.50px] text-black text-responsive"
                    >
                      {content[languageindex].headerTitle}
                    </Text>
                    <Text
                      size="4lg"
                      as="h3"
                      className="font-lora-regular text-black uppercase"
                    >
                      |{content[languageindex].titulo1}|
                      {content[languageindex].titulo2}
                      {content[languageindex].titulo3}|
          ...
          >
            <div className="flex flex-row md:flex-col items-center md:max-w-screen-xl md:mx-auto my-8">
              <div className="h-screen px-4 md:h-auto md:relative md:w-full md:max-w-[379px] flex justify-center md:justify-end">
                <img
                  src={content[languageindex].personalimage}
                  alt="container"
                  className="w-[379px] h-auto object-cover md:static md:w-auto md:h-auto md:transform-none md:max-h-[80vh]"
                />
              </div>
              <div className="flex flex-col justify-center items-start md:items-center md:pl-10 md:pr-10 md:w-full mt-8 md:mt-0">
                <div>
                  <p className="text-lg tracking-[0.50px] md:text-base">
                    {content[languageindex].personalInfoTitle}
                  </p>
                  <p className="text-6xl mt-2 tracking-[-1.50px] md:text-3xl">
                    {content[languageindex].headerTitle}
                  </p>
                  <p className="text-4xl w-[81%] leading-[40px] md:text-base md:w-full md:leading-normal">
                    {content[languageindex].personalInfoSubtitle}
                  </p>
                </div>
                <div
                  id="projects"
                  className="tracking-[0.50px] md:text-sm self-end mt-4 md:mt-0"
                >
            ...
            <div className="flex text-white flex-col md:flex-col items-center gap-8">
              ...
              {Portfolio.map((item, index) => (
                <a href={item.link}>
                  {" "}
                  <div
                    className="portfolio-item flex flex-col items-center md:items-start mb-8 md:mb-12"
                  ...
                  >
                    ...
                    <Heading
                      as="h3"
                      className="font-bold uppercase tracking-[2.70px] text-center md:text-left"
                    >
                      {item.Title}
                    </Heading>
                  </div>
          ...
          >
            <div
              id="blog"
              className="w-screen flex items-center justify-center  p-4 md:p-5"
              style={{
                backgroundColor: "#fff",
                backgroundSize: "cover",
                backgroundPosition: "center",
